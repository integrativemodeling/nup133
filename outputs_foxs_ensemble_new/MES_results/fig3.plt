...
set key at 0.268, 1.15 Left reverse samplen 3
#set lmargin 2
#set rmargin 2
set multiplot
f(x)=1
...
set logscale y
set yrange [0.2:190.0]

plot '../23904_merge2_q25.dat' u 1:2:3 with yerrorbars t 'experiment' lc rgb '#333333' pt 1 ps 0.5, \
    './23904.B99990030_MSE_23904_merge2_q25.dat' u 1:3 t '{{/Times-Italic Sc}Nup133}^{2-1157} comparative model ({/Symbol c} = 6.27)' w lines lw 3.5 lc rgb '#e26261', \
...
set format y
set nolog y
set title "Guinier Plot\n{/Arial=21 R_{g} = 48.3 {\261} 0.6 {\305}}" offset 3.4, -3.2 font "Arial, 21"
